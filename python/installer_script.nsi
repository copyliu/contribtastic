...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "EVE国服市场数据收集器"
...
InstallDir "$PROGRAMFILES\EVE国服市场数据收集器"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\EVE国服市场数据收集器.lnk" "$INSTDIR\uploader.exe"
  CreateShortCut "$DESKTOP\EVE国服市场数据收集器.lnk" "$INSTDIR\uploader.exe"
